...
- Enter `https://github.com/marcus-XXXXX/java-tomcat-sample.git` for `Repository URL`.

- Go to the web browser and check the branch name of the git project `https://github.com/marcus-XXXXX/java-tomcat-sample.git`. 
